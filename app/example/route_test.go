...
func (routeTestAuthRepository) GetByEmail(ctx context.Context, email string) (types.AuthUser, error) {
...
func TestAuthLoginRouteIsPublicWhenJWTEnabled(t *testing.T) {
	...
	router := NewRouter(RouterDeps{
		Config:      cfg,
		AuthService: service.NewAuthService(cfg.Auth, routeTestAuthRepository{}),
	})
